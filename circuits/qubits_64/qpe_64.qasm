...
h q[61];
h q[62];
u3(pi,-pi,-0.1023690042072336) psi[0];
cx psi[0],q[0];
u1(-0.1023690042072337) q[0];
cx psi[0],q[0];
u1(0.1023690042072337) q[0];
u1(0.2047380084144674) psi[0];
cx psi[0],q[1];
u1(-0.2047380084144674) q[1];
cx psi[0],q[1];
u1(0.2047380084144674) q[1];
u1(0.4094760168289348) psi[0];
cx psi[0],q[2];
u1(-0.4094760168289348) q[2];
cx psi[0],q[2];
u1(0.4094760168289348) q[2];
u1(0.8189520336578696) psi[0];
cx psi[0],q[3];
u1(-0.8189520336578696) q[3];
cx psi[0],q[3];
u1(0.8189520336578696) q[3];
u1(-1.5036885862740537) psi[0];
cx psi[0],q[4];
u1(1.5036885862740537) q[4];
cx psi[0],q[4];
u1(-1.5036885862740537) q[4];
u1(0.13421548104168562) psi[0];
cx psi[0],q[5];
u1(-0.13421548104168562) q[5];
cx psi[0],q[5];
u1(0.13421548104168562) q[5];
u1(0.26843096208337125) psi[0];
cx psi[0],q[6];
u1(-0.26843096208337125) q[6];
cx psi[0],q[6];
u1(0.26843096208337125) q[6];
u1(0.5368619241667425) psi[0];
cx psi[0],q[7];
u1(-0.5368619241667425) q[7];
cx psi[0],q[7];
u1(0.5368619241667425) q[7];
u1(1.073723848333485) psi[0];
cx psi[0],q[8];
u1(-1.073723848333485) q[8];
cx psi[0],q[8];
u1(1.073723848333485) q[8];
u1(-0.9941449569228232) psi[0];
cx psi[0],q[9];
u1(0.9941449569228232) q[9];
cx psi[0],q[9];
u1(-0.9941449569228232) q[9];
u1(1.1533027397441467) psi[0];
cx psi[0],q[10];
u1(-1.1533027397441467) q[10];
cx psi[0],q[10];
u1(1.1533027397441467) q[10];
u1(-0.8349871741014997) psi[0];
cx psi[0],q[11];
u1(0.8349871741014997) q[11];
cx psi[0],q[11];
u1(-0.8349871741014997) q[11];
u1(1.4716183053867937) psi[0];
cx psi[0],q[12];
u1(-1.4716183053867937) q[12];
cx psi[0],q[12];
u1(1.4716183053867937) q[12];
u1(-0.1983560428162056) psi[0];
cx psi[0],q[13];
u1(0.1983560428162056) q[13];
cx psi[0],q[13];
u1(-0.1983560428162056) q[13];
u1(-0.3967120856324112) psi[0];
cx psi[0],q[14];
u1(0.3967120856324112) q[14];
cx psi[0],q[14];
u1(-0.3967120856324112) q[14];
u1(-0.7934241712648225) psi[0];
cx psi[0],q[15];
u1(0.7934241712648225) q[15];
cx psi[0],q[15];
u1(-0.7934241712648225) q[15];
u1(1.5547443110601482) psi[0];
cx psi[0],q[16];
u1(-1.5547443110601482) q[16];
cx psi[0],q[16];
u1(1.5547443110601482) q[16];
u1(-0.032104031469496475) psi[0];
cx psi[0],q[17];
u1(0.032104031469496475) q[17];
cx psi[0],q[17];
u1(-0.032104031469496475) q[17];
u1(-0.06420806293899295) psi[0];
cx psi[0],q[18];
u1(0.06420806293899295) q[18];
cx psi[0],q[18];
u1(-0.06420806293899295) q[18];
u1(-0.1284161258779859) psi[0];
cx psi[0],q[19];
u1(0.1284161258779859) q[19];
cx psi[0],q[19];
u1(-0.1284161258779859) q[19];
u1(-0.2568322517559718) psi[0];
cx psi[0],q[20];
u1(0.2568322517559718) q[20];
cx psi[0],q[20];
u1(-0.2568322517559718) q[20];
u1(-0.5136645035119436) psi[0];
cx psi[0],q[21];
u1(0.5136645035119436) q[21];
cx psi[0],q[21];
u1(-0.5136645035119436) q[21];
u1(-1.0273290070238872) psi[0];
cx psi[0],q[22];
u1(1.0273290070238872) q[22];
cx psi[0],q[22];
u1(-1.0273290070238872) q[22];
u1(1.0869346395420187) psi[0];
cx psi[0],q[23];
u1(-1.0869346395420187) q[23];
cx psi[0],q[23];
u1(1.0869346395420187) q[23];
u1(-0.9677233745057557) psi[0];
cx psi[0],q[24];
u1(0.9677233745057557) q[24];
cx psi[0],q[24];
u1(-0.9677233745057557) q[24];
u1(1.2061459045782816) psi[0];
cx psi[0],q[25];
u1(-1.2061459045782816) q[25];
cx psi[0],q[25];
u1(1.2061459045782816) q[25];
u1(-0.7293008444332297) psi[0];
cx psi[0],q[26];
u1(0.7293008444332297) q[26];
cx psi[0],q[26];
u1(-0.7293008444332297) q[26];
u1(-1.4586016888664595) psi[0];
cx psi[0],q[27];
u1(1.4586016888664595) q[27];
cx psi[0],q[27];
u1(-1.4586016888664595) q[27];
u1(0.224389275856874) psi[0];
cx psi[0],q[28];
u1(-0.224389275856874) q[28];
cx psi[0],q[28];
u1(0.224389275856874) q[28];
u1(0.448778551713748) psi[0];
cx psi[0],q[29];
u1(-0.448778551713748) q[29];
cx psi[0],q[29];
u1(0.448778551713748) q[29];
u1(0.897557103427496) psi[0];
cx psi[0],q[30];
u1(-0.897557103427496) q[30];
cx psi[0],q[30];
u1(0.897557103427496) q[30];
u1(-1.3464784467348012) psi[0];
cx psi[0],q[31];
u1(1.3464784467348012) q[31];
cx psi[0],q[31];
u3(0,0,-1.3464784474662603) q[31];
u1(0.4486357601201907) psi[0];
cx psi[0],q[32];
u1(-0.4486357601201907) q[32];
cx psi[0],q[32];
u1(0.4486357601201907) q[32];
cx q[30],q[32];
cx q[32],q[30];
