...
h q[97];
h q[98];
u3(pi,-pi,-1.346521583071725) psi[0];
cx psi[0],q[0];
u1(-1.346521583071725) q[0];
cx psi[0],q[0];
u1(1.346521583071725) q[0];
u1(-0.4485494874463434) psi[0];
cx psi[0],q[1];
u1(0.4485494874463434) q[1];
cx psi[0],q[1];
u1(-0.4485494874463434) q[1];
u1(-0.8970989748926868) psi[0];
cx psi[0],q[2];
u1(0.8970989748926868) q[2];
cx psi[0],q[2];
u1(-0.8970989748926868) q[2];
u1(1.3473947038044196) psi[0];
cx psi[0],q[3];
u1(-1.3473947038044196) q[3];
cx psi[0],q[3];
u1(1.3473947038044196) q[3];
u1(-0.4468032459809539) psi[0];
cx psi[0],q[4];
u1(0.4468032459809539) q[4];
cx psi[0],q[4];
u1(-0.4468032459809539) q[4];
u1(-0.8936064919619078) psi[0];
cx psi[0],q[5];
u1(0.8936064919619078) q[5];
cx psi[0],q[5];
u1(-0.8936064919619078) q[5];
u1(1.3543796696659773) psi[0];
cx psi[0],q[6];
u1(-1.3543796696659773) q[6];
cx psi[0],q[6];
u1(1.3543796696659773) q[6];
u1(-0.4328333142578383) psi[0];
cx psi[0],q[7];
u1(0.4328333142578383) q[7];
cx psi[0],q[7];
u1(-0.4328333142578383) q[7];
u1(-0.8656666285156766) psi[0];
cx psi[0],q[8];
u1(0.8656666285156766) q[8];
cx psi[0],q[8];
u1(-0.8656666285156766) q[8];
u1(1.4102593965584398) psi[0];
cx psi[0],q[9];
u1(-1.4102593965584398) q[9];
cx psi[0],q[9];
u1(1.4102593965584398) q[9];
u1(-0.3210738604729133) psi[0];
cx psi[0],q[10];
u1(0.3210738604729133) q[10];
cx psi[0],q[10];
u1(-0.3210738604729133) q[10];
u1(-0.6421477209458266) psi[0];
cx psi[0],q[11];
u1(0.6421477209458266) q[11];
cx psi[0],q[11];
u1(-0.6421477209458266) q[11];
u1(-1.2842954418916532) psi[0];
cx psi[0],q[12];
u1(1.2842954418916532) q[12];
cx psi[0],q[12];
u1(-1.2842954418916532) q[12];
u1(0.5730017698064863) psi[0];
cx psi[0],q[13];
u1(-0.5730017698064863) q[13];
cx psi[0],q[13];
u1(0.5730017698064863) q[13];
u1(1.1460035396129726) psi[0];
cx psi[0],q[14];
u1(-1.1460035396129726) q[14];
cx psi[0],q[14];
u1(1.1460035396129726) q[14];
u1(-0.8495855743638477) psi[0];
cx psi[0],q[15];
u1(0.8495855743638477) q[15];
cx psi[0],q[15];
u1(-0.8495855743638477) q[15];
u1(1.4424215048620979) psi[0];
cx psi[0],q[16];
u1(-1.4424215048620979) q[16];
cx psi[0],q[16];
u1(1.4424215048620979) q[16];
u1(-0.25674964386559757) psi[0];
cx psi[0],q[17];
u1(0.25674964386559757) q[17];
cx psi[0],q[17];
u1(-0.25674964386559757) q[17];
u1(-0.5134992877311951) psi[0];
cx psi[0],q[18];
u1(0.5134992877311951) q[18];
cx psi[0],q[18];
u1(-0.5134992877311951) q[18];
u1(-1.0269985754623903) psi[0];
cx psi[0],q[19];
u1(1.0269985754623903) q[19];
cx psi[0],q[19];
u1(-1.0269985754623903) q[19];
u1(1.0875955026650126) psi[0];
cx psi[0],q[20];
u1(-1.0875955026650126) q[20];
cx psi[0],q[20];
u1(1.0875955026650126) q[20];
u1(-0.9664016482597679) psi[0];
cx psi[0],q[21];
u1(0.9664016482597679) q[21];
cx psi[0],q[21];
u1(-0.9664016482597679) q[21];
u1(1.2087893570702575) psi[0];
cx psi[0],q[22];
u1(-1.2087893570702575) q[22];
cx psi[0],q[22];
u1(1.2087893570702575) q[22];
u1(-0.7240139394492784) psi[0];
cx psi[0],q[23];
u1(0.7240139394492784) q[23];
cx psi[0],q[23];
u1(-0.7240139394492784) q[23];
u1(-1.4480278788985568) psi[0];
cx psi[0],q[24];
u1(1.4480278788985568) q[24];
cx psi[0],q[24];
u1(-1.4480278788985568) q[24];
u1(0.24553689579267987) psi[0];
cx psi[0],q[25];
u1(-0.24553689579267987) q[25];
cx psi[0],q[25];
u1(0.24553689579267987) q[25];
u1(0.49107379158535974) psi[0];
cx psi[0],q[26];
u1(-0.49107379158535974) q[26];
cx psi[0],q[26];
u1(0.49107379158535974) q[26];
u1(0.9821475831707195) psi[0];
cx psi[0],q[27];
u1(-0.9821475831707195) q[27];
cx psi[0],q[27];
u1(0.9821475831707195) q[27];
u1(-1.1772974872483541) psi[0];
cx psi[0],q[28];
u1(1.1772974872483541) q[28];
cx psi[0],q[28];
u1(-1.1772974872483541) q[28];
u1(0.7869976790930847) psi[0];
cx psi[0],q[29];
u1(-0.7869976790930847) q[29];
cx psi[0],q[29];
u1(0.7869976790930847) q[29];
u1(-1.5675972954036235) psi[0];
cx psi[0],q[30];
u1(1.5675972954036235) q[30];
cx psi[0],q[30];
u1(-1.5675972954036235) q[30];
u1(0.006398062782545948) psi[0];
cx psi[0],q[31];
u1(-0.006398062782545948) q[31];
cx psi[0],q[31];
u1(0.006398062782545948) q[31];
u1(0.012796125565091895) psi[0];
cx psi[0],q[32];
u1(-0.012796125565091895) q[32];
cx psi[0],q[32];
u1(0.012796125565091895) q[32];
u1(0.02559225113018379) psi[0];
cx psi[0],q[33];
u1(-0.02559225113018379) q[33];
cx psi[0],q[33];
u1(0.02559225113018379) q[33];
u1(0.05118450226036758) psi[0];
cx psi[0],q[34];
u1(-0.05118450226036758) q[34];
cx psi[0],q[34];
u1(0.05118450226036758) q[34];
u1(0.10236900452073516) psi[0];
cx psi[0],q[35];
u1(-0.10236900452073516) q[35];
cx psi[0],q[35];
u1(0.10236900452073516) q[35];
u1(0.20473800904147033) psi[0];
cx psi[0],q[36];
u1(-0.20473800904147033) q[36];
cx psi[0],q[36];
u1(0.20473800904147033) q[36];
u1(0.40947601808294065) psi[0];
cx psi[0],q[37];
u1(-0.40947601808294065) q[37];
cx psi[0],q[37];
u1(0.40947601808294065) q[37];
u1(0.8189520361658813) psi[0];
cx psi[0],q[38];
u1(-0.8189520361658813) q[38];
cx psi[0],q[38];
u1(0.8189520361658813) q[38];
u1(-1.5036885812580307) psi[0];
cx psi[0],q[39];
u1(1.5036885812580307) q[39];
cx psi[0],q[39];
u1(-1.5036885812580307) q[39];
u1(0.13421549107373182) psi[0];
cx psi[0],q[40];
u1(-0.13421549107373182) q[40];
cx psi[0],q[40];
u1(0.13421549107373182) q[40];
u1(0.26843098214746364) psi[0];
cx psi[0],q[41];
u1(-0.26843098214746364) q[41];
cx psi[0],q[41];
u1(0.26843098214746364) q[41];
u1(0.5368619642949273) psi[0];
cx psi[0],q[42];
u1(-0.5368619642949273) q[42];
cx psi[0],q[42];
u1(0.5368619642949273) q[42];
u1(1.0737239285898545) psi[0];
cx psi[0],q[43];
u1(-1.0737239285898545) q[43];
cx psi[0],q[43];
u1(1.0737239285898545) q[43];
u1(-0.9941447964100841) psi[0];
cx psi[0],q[44];
u1(0.9941447964100841) q[44];
cx psi[0],q[44];
u1(-0.9941447964100841) q[44];
u1(1.1533030607696249) psi[0];
cx psi[0],q[45];
u1(-1.1533030607696249) q[45];
cx psi[0],q[45];
u1(1.1533030607696249) q[45];
u1(-0.8349865320505435) psi[0];
cx psi[0],q[46];
u1(0.8349865320505435) q[46];
cx psi[0],q[46];
u1(-0.8349865320505435) q[46];
u1(1.471619589488706) psi[0];
cx psi[0],q[47];
u1(-1.471619589488706) q[47];
cx psi[0],q[47];
u1(1.471619589488706) q[47];
u1(-0.19835347461238112) psi[0];
cx psi[0],q[48];
u1(0.19835347461238112) q[48];
cx psi[0],q[48];
u1(-0.19835347461238112) q[48];
u1(-0.39670694922476224) psi[0];
cx psi[0],q[49];
u1(0.39670694922476224) q[49];
cx psi[0],q[49];
u3(0,0,-0.39670694922619365) q[49];
u1(-0.7934138984495245) psi[0];
cx psi[0],q[50];
u1(0.7934138984495245) q[50];
cx psi[0],q[50];
u1(-0.7934138984495245) q[50];
cx q[48],q[50];
cx q[50],q[48];
